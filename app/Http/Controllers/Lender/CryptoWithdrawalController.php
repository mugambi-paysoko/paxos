...
class CryptoWithdrawalController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('lender.crypto-withdrawals.index', compact('cryptoWithdrawals', 'cryptoWithdrawalsIndexDigest'));
    }
    ...
    public function create(Profile $profile)
    {
        ...
        return view('lender.crypto-withdrawals.create', compact('profile'));
    }
    ...
    public function store(Request $request, Profile $profile)
    {
        ...
        try {
            ...
            return redirect()->route('lender.crypto-withdrawals.show', $cryptoWithdrawal)
    ...
    public function show(CryptoWithdrawal $cryptoWithdrawal)
    {
        ...
        return view('lender.crypto-withdrawals.show', compact('cryptoWithdrawal'));
    }
}
