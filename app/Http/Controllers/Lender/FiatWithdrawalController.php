...
class FiatWithdrawalController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('lender.fiat-withdrawals.index', compact('fiatWithdrawals', 'fiatWithdrawalsIndexDigest'));
    }
    ...
    public function create()
    {
        ...
        return view('lender.fiat-withdrawals.create', compact('profiles', 'fiatAccounts'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('lender.fiat-withdrawals.show', $fiatWithdrawal)
    ...
    public function show(FiatWithdrawal $fiatWithdrawal)
    {
        ...
        return view('lender.fiat-withdrawals.show', compact('fiatWithdrawal'));
    }
}
