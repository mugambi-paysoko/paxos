...
class FiatDepositInstructionController extends Controller
{
    ...
    {
        $instructions = auth()->user()->fiatDepositInstructions()
            ->with('profile.account.identity')
            ->latest()
            ->get();

        return view('lender.fiat-deposit-instructions.index', compact('instructions'));
    }
    ...
    public function show(FiatDepositInstruction $fiatDepositInstruction)
    {
        ...
        return view('lender.fiat-deposit-instructions.show', compact('fiatDepositInstruction'));
    }
    ...
    public function create(Profile $profile)
    {
        ...
        return view('lender.fiat-deposit-instructions.create', compact('profile'));
    }
    ...
    public function store(Request $request, Profile $profile)
    {
        ...
        try {
            ...
            return redirect()->route('lender.profiles.show', $profile)
    ...
    public function initiateDeposit(Request $request, FiatDepositInstruction $fiatDepositInstruction)
    {
        ...
        try {
            ...
            return redirect()->route('lender.fiat-deposit-instructions.show', $fiatDepositInstruction)
