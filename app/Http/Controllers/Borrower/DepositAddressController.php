...
class DepositAddressController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('borrower.deposit-addresses.index', compact('depositAddresses'));
    }
    ...
    public function create(Profile $profile)
    {
        ...
        return view('borrower.deposit-addresses.create', compact('profile'));
    }
    ...
    public function store(Request $request, Profile $profile)
    {
        ...
        try {
            ...
            return redirect()->route('borrower.deposit-addresses.index')
