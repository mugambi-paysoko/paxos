...
<head>
    ...
    <title>@yield('title', 'Borrower') — {{ config('app.name', 'Paxos') }}</title>
    @stack('styles')
    <style>
        body.borrower-portal {
            --bs-body-font-weight: 500;
            font-weight: 500;
            -webkit-font-smoothing: antialiased;
        }

        .borrower-portal.borrower-portal--crypto {
        ...
        .borrower-portal .navbar-nav .nav-link {
            font-weight: 500;
        }

        .borrower-portal .form-label,
        .borrower-portal .btn {
            font-weight: 500;
        }

        .borrower-portal #main-wrapper .left-sidebar {
            display: none !important;
        }

        .borrower-portal #main-wrapper .page-wrapper {
            margin-inline-start: 0 !important;
        }

        .borrower-portal .borrower-topnav {
        ...
        [data-bs-theme="dark"] .borrower-portal .borrower-topnav {
        ...
        .borrower-portal--crypto .borrower-nav-link--active {
        ...
        [data-bs-theme="dark"] .borrower-page-hero {
        ...
        .borrower-crypto-mono {
            font-variant-numeric: tabular-nums;
        }

        .borrower-portal--crypto .round.rounded {
            width: 45px;
            height: 45px;
            flex-shrink: 0;
        }
...
<body class="borrower-portal borrower-portal--crypto">
    <div id="main-wrapper">
        <div class="page-wrapper">
            <header class="topbar borrower-topnav border-bottom shadow-sm">
                <nav class="navbar navbar-expand-xl container-fluid px-lg-4 py-2">
                    ...
                    <button class="navbar-toggler border-0 shadow-none px-2" type="button" data-bs-toggle="collapse" data-bs-target="#borrowerNavbar" aria-controls="borrowerNavbar" aria-expanded="false" aria-label="Toggle navigation">
                        <i class="ti ti-menu-2 fs-7"></i>
                    </button>
                    <div class="collapse navbar-collapse" id="borrowerNavbar">
                        <div class="navbar-nav-scroll mx-xl-4 my-3 my-xl-0 flex-grow-1">
                            @include('layouts.partials.borrower-nav')
                        </div>
                        <ul class="navbar-nav flex-row ms-auto align-items-center gap-1">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link d-flex align-items-center gap-2 pe-2" href="javascript:void(0)" id="borrowerUserMenu" data-bs-toggle="dropdown" aria-expanded="false">
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up shadow rounded-4" aria-labelledby="borrowerUserMenu" style="min-width: 220px;">
            ...
            <div class="body-wrapper">
                <div class="container-fluid px-lg-4 py-4">
                    ...
                    @hasSection('page_hero')
                        @yield('page_hero')
                    @else
                        <div class="card borrower-page-hero shadow-sm rounded-4 overflow-hidden mb-4">
                            <div class="card-body px-4 py-4">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <p class="text-uppercase fs-2 text-muted fw-semibold mb-1" style="letter-spacing: 0.06em;">Portfolio</p>
