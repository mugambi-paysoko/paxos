...
@section('page_actions')
    <a href="{{ route('borrower.profiles.fiat-deposit-instructions.create', $profile) }}" class="btn btn-primary rounded-3">
        <i class="ti ti-building-bank me-1"></i> Fiat deposit
    </a>
    <a href="{{ route('borrower.profiles.deposit-addresses.create', $profile) }}" class="btn btn-outline-primary rounded-3">
        <i class="ti ti-qrcode me-1"></i> Crypto address
    </a>
    <a href="{{ route('borrower.fiat-withdrawals.create') }}" class="btn btn-outline-primary rounded-3">
        <i class="ti ti-arrow-up-right me-1"></i> Fiat withdrawal
    </a>
    <a href="{{ route('borrower.profiles.crypto-withdrawals.create', $profile) }}" class="btn btn-outline-primary rounded-3">
        <i class="ti ti-currency-bitcoin me-1"></i> Crypto withdrawal
    </a>
    <a href="{{ route('borrower.profiles.index') }}" class="btn btn-outline-secondary rounded-3">Back</a>
@endsection
    ...
    <div class="card shadow-sm border-0 rounded-4 mb-4">
        <div class="card-body p-4 p-md-5">
            <div class="d-flex align-items-center justify-content-between gap-2 mb-3">
                ...
                <a href="{{ route('borrower.accounts.show', $profile->account) }}" class="btn btn-sm btn-outline-primary rounded-3">View account</a>
            </div>
            <p class="mb-0 text-muted">Use this profile to create deposit instructions, generate crypto addresses, and initiate withdrawals. All related transfer activity is listed below.</p>
        </div>
    </div>
        ...
        <div class="card shadow-sm border-0 rounded-4 mb-4">
            <div class="card-body p-4 p-md-5">
                <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 mb-3">
                    ...
                    <a href="{{ route('borrower.deposit-addresses.index') }}" class="btn btn-sm btn-outline-primary rounded-3">View all</a>
                </div>
                        ...
                        <tbody>
                            @foreach ($profile->fiatDepositInstructions as $instruction)
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <a href="{{ route('borrower.fiat-deposit-instructions.show', $instruction) }}" class="btn btn-sm btn-outline-primary rounded-3">View</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
