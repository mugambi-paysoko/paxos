...
@section('page_actions')
    <form action="{{ route('borrower.fiat-accounts.refresh', $fiatAccount) }}" method="POST" class="d-inline">
        @csrf
        <button type="submit" class="btn btn-success rounded-3">
            <i class="ti ti-refresh me-1"></i> Refresh status
        </button>
    </form>
    <a href="{{ route('borrower.fiat-accounts.index') }}" class="btn btn-outline-secondary rounded-3">
