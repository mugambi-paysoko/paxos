...
<div class="py-6">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('lender.identities.create') }}" class="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded">
            Create Identity
        </a>
    </div>
    ...
    <div class="bg-white shadow overflow-hidden sm:rounded-md">
        <ul class="divide-y divide-gray-200">
            ...
            <li>
                <a href="{{ route('lender.identities.show', $identity) }}" class="block hover:bg-gray-50">
            ...
            <li class="px-4 py-8 text-center text-gray-500">
                No identities found. <a href="{{ route('lender.identities.create') }}" class="text-indigo-600 hover:text-indigo-500">Create one</a>
            </li>
            @endforelse
        </ul>
    </div>
