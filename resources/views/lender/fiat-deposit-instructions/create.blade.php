...
<div class="py-6">
    ...
    <div class="bg-white shadow rounded-lg p-6">
        ...
        <form action="{{ route('lender.profiles.fiat-deposit-instructions.store', $profile) }}" method="POST">
            @csrf
            ...
            <div class="mt-6 flex justify-end">
                <a href="{{ route('lender.profiles.show', $profile) }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded mr-4">
                    Cancel
                </a>
