...
<div class="py-6">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('lender.accounts.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded">
            Back
        </a>
    </div>
    ...
    <div class="bg-white shadow rounded-lg p-6">
        ...
        <div class="mt-6 pt-6 border-t border-gray-200">
            ...
            <dl class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    <a href="{{ route('lender.profiles.show', $account->profile) }}" class="text-indigo-600 hover:text-indigo-500">
